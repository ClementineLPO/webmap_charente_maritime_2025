...
var format_Maillesprospectesen2022etou2023etou2024_3 = new ol.format.GeoJSON();
var features_Maillesprospectesen2022etou2023etou2024_3 = format_Maillesprospectesen2022etou2023etou2024_3.readFeatures(json_Maillesprospectesen2022etou2023etou2024_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Maillesprospectesen2022etou2023etou2024_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Maillesprospectesen2022etou2023etou2024_3.addFeatures(features_Maillesprospectesen2022etou2023etou2024_3);
var lyr_Maillesprospectesen2022etou2023etou2024_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Maillesprospectesen2022etou2023etou2024_3, 
                style: style_Maillesprospectesen2022etou2023etou2024_3,
                popuplayertitle: 'Mailles prospectées en 2022 et/ ou 2023 et/ou 2024',
                interactive: false,
                title: '<img src="styles/legend/Maillesprospectesen2022etou2023etou2024_3.png" /> Mailles prospectées en 2022 et/ ou 2023 et/ou 2024'
            });
...
var format_Donnesdelenqute2024_6 = new ol.format.GeoJSON();
var features_Donnesdelenqute2024_6 = format_Donnesdelenqute2024_6.readFeatures(json_Donnesdelenqute2024_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Donnesdelenqute2024_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Donnesdelenqute2024_6.addFeatures(features_Donnesdelenqute2024_6);
var lyr_Donnesdelenqute2024_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Donnesdelenqute2024_6, 
                style: style_Donnesdelenqute2024_6,
                popuplayertitle: 'Données de l\'enquête 2024',
                interactive: false,
    title: 'Données de l\'enquête 2024<br />\
    <img src="styles/legend/Donnesdelenqute2024_6_0.png" /> Hirondelle rustique<br />\
    <img src="styles/legend/Donnesdelenqute2024_6_1.png" /> Hirondelle de fenêtre<br />' });

lyr_GoogleSatelliteHybrid_0.setVisible(false);lyr_OSMStandard_1.setVisible(false);lyr_Limitesdescommunes_2.setVisible(true);lyr_Maillesprospectesen2022etou2023etou2024_3.setVisible(true);lyr_MaillesprospecterpourlenquteHirondelles_4.setVisible(true);lyr_Autresdonnesantrieures_5.setVisible(true);lyr_Donnesdelenqute2024_6.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_OSMStandard_1,lyr_Limitesdescommunes_2,lyr_Maillesprospectesen2022etou2023etou2024_3,lyr_MaillesprospecterpourlenquteHirondelles_4,lyr_Autresdonnesantrieures_5,lyr_Donnesdelenqute2024_6];
...
lyr_Donnesdelenqute2024_6.set('fieldImages', {'Ref': 'Range', 'Nom_espece': 'TextEdit', 'Details': 'TextEdit', 'Identifian': 'TextEdit', 'Département': 'Range', 'Commune_2': 'TextEdit', 'X_Lambert93_.m.': 'Range', 'Y_Lambert93_.m.': 'Range', 'Nids.naturels.occupés': 'Range', 'Nids.artificiels.occupés': 'Range', 'Nombre.de.nids.occupés.par.d.autres.espèces': 'Range', 'Nids.artificiels.occupés.par.une.autre.espèce': 'Range', 'Nombre.de.nids.détruits': 'Range', 'Nids.artificiels.détruits': 'Range', 'Nombre.de.nids.en.construction': 'Range', 'pres_abs': 'CheckBox', 'nids_naturels_actifs': 'Range', 'nids_artificiels_actifs': 'Range', 'nids_naturels_perdus': 'Range', 'nids_artificiels_perdus': 'Range', 'nids_naturels_inoccupes': 'Range', 'nids_artificiels_inoccupes': 'Range', 'nids_naturels_bon_etat': 'Range', 'nids_artificiels_bon_etat': 'Range', });
